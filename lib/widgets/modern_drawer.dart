...
class ModernDrawer extends StatelessWidget {
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _drawerItem(context, AppIcons.appointment, getTranslated(context, AppString.drawer_appointments).toString(), () => Navigator.popAndPushNamed(context, 'AppointmentHistoryScreen'), badge: _pulsingDot(Colors.green)),
                  ...
                  _drawerItem(context, AppIcons.star, getTranslated(context, AppString.drawer_review).toString(), () => Navigator.popAndPushNamed(context, 'rateAndReviewRoutes'), badge: _pulsingDot(AyurezeTheme.healingGreen50)),
  ...
  Widget _drawerItem(BuildContext context, IconData icon, String label, VoidCallback onTap, {bool isDestructive = false, Widget? badge}) {
    return Container(
